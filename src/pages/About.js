  ...
  return (
    <main className="df wp rw jcc aic about"> 
      ...
      <section className="df rw wp jcc aic d-df d-wp d-rw d-jcc d-aist">
        ...
        <article className="df wp rw jcc aic box">
          <h2>VISIÓN</h2>
          <p>Ser una empresa líder en el mercado manteniendo nuestra calidad en el servicio de impresos gráficos, ofreciendo nuestros servicios a través de un proceso de mejora continua.</p>
        </article>
      </section>
    </main>
  );
