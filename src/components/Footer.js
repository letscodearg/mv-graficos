    ...
    <footer className="df cl" id="footer">
      <section className="df rw wp jca ais">
        <article className="df cl wp">
          ...
          <Link to="/lineas" className="link">
            Líneas de Productos
          </Link>
          <Link to="/equipamiento" className="link">
            Equipamiento
          </Link>
          <Link to="/calidad" className="link">
            Política de Calidad
          </Link>
        ...
        <article className="df cl wp">
          ...
          <section className="df rw wp jcc d-jce aic" id="calidad">
            <img src={iso} alt="iso9001" id="iso" />
            <img src={fsc} alt="fsc" id="fsc" />
          </section>
        </article>
      </section>
      <section className="df rw wp jcc aic" id="copyright">
        <p>© Copyright 2023 – MV Gráficos</p>
        <a href="http://letscode.com.ar" target="_blank" rel="noreferrer">
          <img src={letscode} alt="Lets Code" />
        </a>
      </section>
    </footer>
  );
